...
#define ID_TIMER1               5001


long __stdcall GLUnhandledExceptionFilter( struct _EXCEPTION_POINTERS *ExceptionInfo )
{
...
BEGIN_EVENT_TABLE(MyFrame, wxFrame)
    ...
    EVT_TIMER(ID_TIMER1, MyFrame::OnTimer)
END_EVENT_TABLE()
...
//    SetIcon(wxIcon(sample_xpm));
    ...
    m_timer1.Start(1000, wxTIMER_ONE_SHOT);
...
bool MyApp::OnInit()
{
    SetUnhandledExceptionFilter(&GLUnhandledExceptionFilter);
